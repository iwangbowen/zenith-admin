...
| 5. Service | `packages/server/src/services/xxx.service.ts` | [crud-backend.md](./references/crud-backend.md) |
| 6. Route | `packages/server/src/routes/xxx.ts` | [crud-backend.md](./references/crud-backend.md) |
| 7. 注册路由 | `packages/server/src/index.ts` | [crud-backend.md](./references/crud-backend.md) |
| 8. 页面 | `packages/web/src/pages/xxx/XxxPage.tsx` | [crud-frontend.md](./references/crud-frontend.md) |
| 9. 菜单/权限 | `packages/shared/src/seed-data.ts` | [seed-config.md](./references/seed-config.md) |
| 10. 种子数据 | `packages/server/src/db/seed.ts` | [seed-config.md](./references/seed-config.md) |
| 11. MSW Mock | `packages/web/src/mocks/` | [crud-mock.md](./references/crud-mock.md)（仅需 Demo 时） |
