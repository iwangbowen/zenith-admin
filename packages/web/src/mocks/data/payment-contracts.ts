...
export const mockPaymentContracts: PaymentContract[] = [
  ...
  },
  {
    ...
    channel: 'alipay',
    channelConfigId: 2, channelAccountId: 2, credentialVersion: 1,
    appId: 3,
    currency: 'CNY',
    planId: 2,
    planName: '连续包周 VIP',
  ...
  {
    id: 3,
    contractNo: 'CT17580000000003003',
    channel: 'wechat',
    channelConfigId: 1, channelAccountId: 1, credentialVersion: 1,
    appId: 1,
    currency: 'CNY',
    ...
    planPeriod: 'monthly',
    planAmount: 1500,
    signerAccount: 'oDemo_pending_003',
    signerName: '待确认用户',
    status: 'unknown',
    unknownOperation: 'sign',
    version: 1,
    errorMessage: '渠道签约结果待确认',
    channelContractNo: null,
    bizType: 'admin_contract',
    bizId: 'ADM1758000000300',
    nextDeductAt: null,
    lastDeductAt: null,
    failCount: 0,
    totalDeductCount: 0,
