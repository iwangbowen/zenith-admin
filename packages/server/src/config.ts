...
const envSchema = z.object({
  ...
  CMS_THEME_STORAGE_ROOT: z.string().default(''),
...
export const config = {
  ...
  cmsThemes: {
    storageRoot: env.CMS_THEME_STORAGE_ROOT || undefined,
    trustedPublicKeys: env.CMS_THEME_TRUSTED_PUBLIC_KEYS,
    signingKeyId: env.CMS_THEME_SIGNING_KEY_ID,
    signingPrivateKey: env.CMS_THEME_SIGNING_PRIVATE_KEY,
    engineVersion: env.CMS_THEME_ENGINE_VERSION,
  },
  redis: {
    url: env.REDIS_URL,
    host: env.REDIS_HOST,
