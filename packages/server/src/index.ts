...
import cmsErrorProneWordsRoutes from './routes/cms/error-prone-words';
import cmsInteractionsRoutes from './routes/cms/interactions';
import cmsStatsRoutes from './routes/cms/stats';
import cmsUploadRoutes from './routes/cms/upload';
import cmsResourcesRoutes from './routes/cms/resources';
import cmsSubscriptionsRoutes from './routes/cms/subscriptions';
import cmsCollectRoutes from './routes/cms/collect';
import cmsPagesRoutes from './routes/cms/pages';
import cmsDashboardRoutes from './routes/cms/dashboard';
import cmsTemplatesRoutes from './routes/cms/templates';
import cmsThemesRoutes from './routes/cms/themes';
import cmsPublishingRoutes from './routes/cms/publishing';
import cmsDistributionRoutes from './routes/cms/distributions';
...
import memberCmsRoutes from './routes/member/member-cms';
...
import paymentPreauthRoutes from './routes/payment/payment-preauths';
...
import rulesFlowsRoutes from './routes/platform/rules-flows';
import rulesListsRoutes from './routes/platform/rules-lists';
...
import developerAppsRoutes from './routes/open-platform/developer-apps';
...
app.route('/api/member/cms', memberCmsRoutes);
...
app.route('/api/payment/preauths', paymentPreauthRoutes);
...
app.route('/api/rules/decision-flows', rulesFlowsRoutes);
app.route('/api/rules/lists', rulesListsRoutes);
...
app.route('/api/developer-apps', developerAppsRoutes);
...
app.route('/api/cms/error-prone-words', cmsErrorProneWordsRoutes);
app.route('/api/cms/interactions', cmsInteractionsRoutes);
app.route('/api/cms/stats', cmsStatsRoutes);
app.route('/api/cms/collect', cmsCollectRoutes);
app.route('/api/cms/pages', cmsPagesRoutes);
app.route('/api/cms/dashboard', cmsDashboardRoutes);
app.route('/api/cms/templates', cmsTemplatesRoutes);
app.route('/api/cms/themes', cmsThemesRoutes);
app.route('/api/cms/publishing', cmsPublishingRoutes);
app.route('/api/cms/distributions', cmsDistributionRoutes);
app.route('/api/cms/resources', cmsResourcesRoutes);
app.route('/api/cms/subscriptions', cmsSubscriptionsRoutes);
