...
import cmsSurveysRoutes from './routes/cms/surveys';
...
import cmsPollsRoutes from './routes/cms/polls';
...
app.route('/api/cms/surveys', cmsSurveysRoutes);
...
app.route('/api/cms/polls', cmsPollsRoutes);
