...
import {
  ...
  ccUnreadCountRoute, relationOptionsRoute, detailRoute, printRoute, analyticsRoute, overdueRoute, selectableUsersRoute,
  tasksMonitorRoute,
...
router.openapiRoutes([listRoute, pendingMineRoute, pendingMineCountRoute, allRoute, ccMineRoute, handledMineRoute, ccUnreadCountRoute, relationOptionsRoute, analyticsRoute, overdueRoute, tasksMonitorRoute, selectableUsersRoute, myConsultsRoute, batchWithdrawRoute, batchUrgeRoute, ccReadRoute, diagnosticsRoute, traceRoute, tokensRoute, diagnosticBundleRoute, detailRoute, printRoute, listCommentsRoute, addCommentRoute, createInstanceRoute, updateDraftRoute, submitDraftRoute, resubmitRoute] as const);
