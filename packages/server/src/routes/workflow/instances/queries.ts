...
export const listRoute = defineOpenAPIRoute({
  route: createRoute({
    ...
    request: { query: PaginationQuery.extend({ status: z.string().optional(), priority: z.string().optional(), definitionId: z.coerce.number().int().optional() }) },
...
export const allRoute = defineOpenAPIRoute({
  route: createRoute({
    ...
    request: { query: PaginationQuery.extend({ status: z.string().optional(), keyword: z.string().optional(), categoryId: z.coerce.number().int().optional(), definitionId: z.coerce.number().int().optional(), initiatorKeyword: z.string().optional(), priority: z.string().optional() }) },
