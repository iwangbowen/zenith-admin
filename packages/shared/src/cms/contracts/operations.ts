...
export const cmsOperationsContract = defineContract('/api/cms/operations', {
  ...
  taskDetail: op.get('/tasks/{id}', { access: { permission: ['cms:dashboard:view', 'cms:editorial-task:manage'] }, params: idParam, response: cmsEditorialTaskSchema, summary: '编辑事项详情' }),
