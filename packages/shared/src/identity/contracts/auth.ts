...
export const authContract = defineContract('/api/auth', {
  ...
  me: op.get('/me', { response: userProfileSchema, summary: '获取当前用户', unmasked: true }),
  updateProfile: op.put('/profile', { body: updateProfileSchema, response: userProfileSchema, summary: '修改个人资料', unmasked: true }),
