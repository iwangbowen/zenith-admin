...
export const SEED_MENUS_COMMON: Menu[] = [
  ...
  // 统一搜索中心：固定路由无角色菜单门禁，菜单管理仍可维护其显示元数据。
  { id: 14, parentId: 0, title: '统一搜索', name: 'GlobalSearch', path: '/search', component: 'search/GlobalSearchPage', icon: 'Search', type: 'menu', sort: 102, status: 'enabled', visible: false, createdAt: SEED_DATE, updatedAt: SEED_DATE },
];
